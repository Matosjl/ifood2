      ...
      <section className="max-w-6xl mx-auto px-4 pt-20 pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 text-lg font-black bg-gradient-to-r from-orange-500 to-orange-400 hover:from-orange-400 hover:to-yellow-400 text-white rounded-2xl transition-all shadow-lg shadow-orange-500/20 hover:scale-105"
          >
          ...
          <a
            ...
            className="w-full sm:w-auto px-8 py-4 text-lg font-semibold text-white bg-green-600/20 hover:bg-green-600/30 border border-green-600/40 rounded-2xl transition-all flex items-center justify-center gap-2"
          >
